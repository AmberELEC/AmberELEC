...
message_stream "runemu.sh may be removed in a future version of 351ELEC. If you have customized es_systems configurations using it, please update them to use runemu.py instead" 0.5
