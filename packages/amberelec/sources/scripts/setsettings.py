...
def set_settings(rom_name: str, core: str, platform: str, controllers: str, autosave: str, snapshot: str) -> str:
    ...
    if device_name == "RG351P":
        system_viewport = {
            ...
            'gamegear': (0, 0, 320, 288),         # x2
            'ggh': (0, 0, 320, 288),              # x2
            'pokemini': (0, 0, 288, 192),        # x3
            'ngp': (0, 0, 320, 304),              # x2
            'ngpc': (0, 0, 320, 304),             # x2
        ...
        system_viewport = {
            ...
            'gamegear': (0, 0, 480, 432),         # x3
            'ggh': (0, 0, 480, 432),              # x3
            'pokemini': (0, 0, 384, 256),        # x4
            'ngp': (0, 0, 480, 456),              # x3
            'ngpc': (0, 0, 480, 456),             # x3
            'wonderswan': (0, 0, 448, 288),      # x2
            'wonderswancolor': (0, 0, 448, 288), # x2
        ...
        system_viewport = {
            ...
            'supervision': (0, 0, 1120, 1120),      # x7
            'gamegear': (0, 0, 1280, 1152),          # x8
            'ggh': (0, 0, 1280, 1152),               # x8
            'pokemini': (0, 0, 1152, 768),         # x12
            'ngp': (0, 0, 1120, 1064),              # x7
            'ngpc': (0, 0, 1120, 1064),             # x7
