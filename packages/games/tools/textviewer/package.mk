...
pre_configure_target() {
  ...
  sed -i 's|SDL_ShowCursor(SDL_TRUE);|SDL_ShowCursor(SDL_FALSE);|g' 3rd_party/imgui/backends/imgui_impl_sdl.cpp
  sed -i 's|SDL_ShowCursor(SDL_TRUE);|SDL_ShowCursor(SDL_FALSE);|g' imgui_impl_sdl.cpp
