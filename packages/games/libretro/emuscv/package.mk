...
PKG_SHORTDESC="An EPOCH/YENO Super Cassette Vision (1984) home video game emulator for Libretro"
PKG_TOOLCHAIN="make"
...
makeinstall_target() {
  ...
  cp $PKG_BUILD/emuscv_libretro.info $INSTALL/usr/lib/libretro/
