...
makeinstall_target() {
  mkdir -p $INSTALL/usr/lib/games/libretro
  cp spring_libretro.so $INSTALL/usr/lib/games/libretro/spring_ppsspp_libretro.so
  cp spring_ppsspp_libretro.info $INSTALL/usr/lib/games/libretro/spring_ppsspp_libretro.info
}
