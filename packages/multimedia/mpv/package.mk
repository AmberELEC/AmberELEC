...
PKG_DEPENDS_TARGET="toolchain ffmpeg SDL2-git ${OPENGLES}"
...
configure_target() {
  ...
  ./waf configure --enable-sdl2 --enable-sdl2-gamepad --disable-pulse --enable-egl --disable-libbluray --disable-drm --disable-gl --opengl-es=yes
}
